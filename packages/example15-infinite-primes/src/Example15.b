// Example 15 -- Infinitely Many Primes.

// In this example we will formalise Euclid's proof that there are
...
interface {
    ...
    ghost function is_prime(n: int): bool
    {
        ...
        return n >= int(2) &&
            (forall (f: int) int(1) < f < n ==> n % f != int(0));
    }
...
// (This function is adapted from Example07.b.)
...
// Now we can write our "make_higher_prime" function.
