...
function f()
{
    var a: i32[*] = alloc_array(100);


    var b: i32[*,*] = alloc_2d_array(10, 10);
    ...
    var v = sizeof(make_array());         // Error, return value of make_array is not freed
    ghost var g2 = sizeof(make_array());  // ... but ok in ghost code
