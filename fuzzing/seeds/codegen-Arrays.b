...
{
    var arr2: i32[*,*];
    alloc_2d_array<i32>(arr2, 3, 4);
    var result = sizeof(arr2).0;
    free_2d_array<i32>(arr2);
    return result;
}
...
{
    var a: {i32,i32}[*];
    alloc_array<{i32,i32}>(a, 10);
    
    var b: i32[*];
    alloc_array<i32>(b, 10);
